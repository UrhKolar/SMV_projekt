...
<head>
    ...
    <title>Gradiva - eKonferenca</title>
...
<body>
    <header class="topbar">
        <div class="brand">eKonferenca - Gradiva</div>
        <nav class="nav">
            ...
            <a href="gradiva.php" class="active">Gradiva</a>
    ...
    <main class="container">
        <section class="card">
            <h2>Gradiva</h2>
            <p>Pregled vseh gradiv v sistemu</p>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            // Render gradiva table with teacher and subject names
            renderTable(
                "tbl-gradiva",
                [
