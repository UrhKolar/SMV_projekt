...
<head>
    ...
    <title>Poizvedbe - eKonferenca</title>
...
<body>
    <header class="topbar">
        <div class="brand">eKonferenca - Poizvedbe</div>
        <nav class="nav">
            ...
            <a href="poizvedbe.php" class="active">Poizvedbe</a>
    ...
    <main class="container">
        <section class="card">
            ...
            <p>Različne poizvedbe in analize podatkov</p>
