...
<head>
    ...
    <title>Predmeti - eKonferenca</title>
...
<body>
    <header class="topbar">
        <div class="brand">eKonferenca - Predmeti</div>
        <nav class="nav">
            ...
            <a href="predmeti.php" class="active">Predmeti</a>
    ...
    <main class="container">
        <section class="card">
            <h2>Predmeti</h2>
            <p>Pregled vseh predmetov v sistemu</p>
