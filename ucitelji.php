...
<head>
    ...
    <title>Učitelji - eKonferenca</title>
...
<body>
    <header class="topbar">
        <div class="brand">eKonferenca - Učitelji</div>
        <nav class="nav">
            ...
            <a href="ucitelji.php" class="active">Učitelji</a>
    ...
    <main class="container">
        <section class="card">
            <h2>Učitelji</h2>
            <p>Pregled vseh učiteljev v sistemu</p>
